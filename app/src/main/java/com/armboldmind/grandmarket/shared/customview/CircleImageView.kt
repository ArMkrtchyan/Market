...
class CircleImageView : AppCompatImageView {
     ...
     */
    var fillColor: Int
        @Deprecated("Use {@link #getCircleBackgroundColor()} instead.") get() = circleBackgroundColor
        @Deprecated("Use {@link #setCircleBackgroundColor(int)} instead.") set(@ColorInt fillColor) {
