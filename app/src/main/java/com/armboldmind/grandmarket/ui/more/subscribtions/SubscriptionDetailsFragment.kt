...
import com.armboldmind.grandmarket.databinding.FragmentSubscriptionDetailsBinding
import com.armboldmind.grandmarket.shared.mvi.states.ViewState
import kotlinx.coroutines.launch

class SubscriptionDetailsFragment : BaseFragment<FragmentSubscriptionDetailsBinding>() {

    override val inflate: (LayoutInflater, ViewGroup?, Boolean) -> FragmentSubscriptionDetailsBinding
        get() = FragmentSubscriptionDetailsBinding::inflate

    override val toolbar: Toolbar
        get() = mBinding.toolbar

    override fun initView(binding: FragmentSubscriptionDetailsBinding, keysFromDb: Keys) {
        binding.apply { }
    }
